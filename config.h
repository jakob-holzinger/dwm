...
static char *fonts[]          = { "monospace:size=14", "NotoColorEmoji:pixelsize=30:antialias=true:autohint=true"  };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_s,           spawn,          {.v = scrscmd} },
